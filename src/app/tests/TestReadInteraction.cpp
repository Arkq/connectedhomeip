...
constexpr chip::ClusterId kTestEventClusterId     = chip::Test::MockClusterId(1);
constexpr chip::ClusterId kInvalidTestClusterId   = 7;
constexpr chip::EndpointId kTestEndpointId        = 1;
constexpr chip::EndpointId kTestEventEndpointId   = chip::Test::kMockEndpoint1;
constexpr chip::EventId kTestEventIdDebug         = chip::Test::MockEventId(1);
constexpr chip::EventId kTestEventIdCritical      = chip::Test::MockEventId(2);
constexpr uint8_t kTestFieldValue1                = 1;
constexpr chip::TLV::Tag kTestEventTag            = chip::TLV::ContextTag(1);
constexpr chip::EndpointId kInvalidTestEndpointId = 3;
...
class TestReadInteraction : public chip::Test::AppContext, public ::testing::Test
{
private:
...
public:
    ...
    void GenerateEvents();
    void GenerateReportData(System::PacketBufferHandle & aPayload, ReportType aReportType, bool aSuppressResponse,
...
public:
    ...
    {
        sSyncScheduler = true;
        TestReadInteraction::SetUpTestSuite();
    }
...
/*
 * Run previously defined fixture's class function as a test.
 */
...
void TestReadInteraction::GenerateReportData(System::PacketBufferHandle & aPayload, TestReadInteraction::ReportType aReportType,
                                             bool aSuppressResponse, bool aHasSubscriptionId)
{
    CHIP_ERROR err = CHIP_NO_ERROR;
...
TEST_F_FROM_FIXTURE(TestReadInteraction, TestReadHandler)
{
    ...
    err           = engine->Init(&GetExchangeManager(), &GetFabricTable(), gReportScheduler);
    EXPECT_EQ(err, CHIP_NO_ERROR);
...
TEST_F_FROM_FIXTURE(TestReadInteraction, TestReadRoundtrip)
{
...
TEST_F_FROM_FIXTURE(TestReadInteraction, TestReadRoundtripWithDataVersionFilter)
{
...
TEST_F_FROM_FIXTURE(TestReadInteraction, TestReadRoundtripWithNoMatchPathDataVersionFilter)
{
...
TEST_F_FROM_FIXTURE(TestReadInteraction, TestReadRoundtripWithMultiSamePathDifferentDataVersionFilter)
{
...
TEST_F_FROM_FIXTURE(TestReadInteraction, TestReadRoundtripWithSameDifferentPathsDataVersionFilter)
{
...
TEST_F_FROM_FIXTURE(TestReadInteraction, TestReadWildcard)
{
...
TEST_F_FROM_FIXTURE(TestReadInteraction, TestReadChunking)
{
...
TEST_F_FROM_FIXTURE(TestReadInteraction, TestSetDirtyBetweenChunks)
{
...
TEST_F_FROM_FIXTURE(TestReadInteraction, TestReadInvalidAttributePathRoundtrip)
{
...
TEST_F_FROM_FIXTURE(TestReadInteraction, TestSubscribeRoundtrip)
{
...

    {
        ...
        EXPECT_TRUE(delegate.mGotReport);
        EXPECT_EQ(delegate.mGotEventResponse, true);
        EXPECT_EQ(delegate.mNumAttributeResponse, 2);
...
TEST_F_FROM_FIXTURE(TestReadInteraction, TestSubscribeWildcard)
{
...

    {
        ...
        constexpr int kExpectedAttributeResponse = 29 * 2 + (kMockAttribute4ListLength - 3) + (kMockAttribute4ListLength - 2);
#else
        ...
        constexpr int kExpectedAttributeResponse = 29 * 2 + (kMockAttribute4ListLength - 4) + (kMockAttribute4ListLength - 4);
#endif
        EXPECT_EQ(delegate.mNumAttributeResponse, kExpectedAttributeResponse);
...
TEST_F_FROM_FIXTURE(TestReadInteraction, TestSubscribePartialOverlap)
{
...
TEST_F_FROM_FIXTURE(TestReadInteraction, TestSubscribeSetDirtyFullyOverlap)
{
...
TEST_F_FROM_FIXTURE(TestReadInteraction, TestSubscribeEarlyShutdown)
{
    Messaging::ReliableMessageMgr * rm = GetExchangeManager().GetReliableMessageMgr();
...
TEST_F_FROM_FIXTURE(TestReadInteraction, TestReadShutdown)
{
    auto * engine = chip::app::InteractionModelEngine::GetInstance();
...
TEST_F_FROM_FIXTURE(TestReadInteraction, TestSubscribeInvalidInterval)
{
...
TEST_F_FROM_FIXTURE(TestReadInteraction, TestSubscribeRoundtripStatusReportTimeout)
{
...
TEST_F_FROM_FIXTURE(TestReadInteraction, TestReadChunkingStatusReportTimeout)
{
...
TEST_F_FROM_FIXTURE(TestReadInteraction, TestReadReportFailure)
{
...
TEST_F_FROM_FIXTURE(TestReadInteraction, TestSubscribeRoundtripChunkStatusReportTimeout)
{
...
TEST_F_FROM_FIXTURE(TestReadInteraction, TestPostSubscribeRoundtripChunkStatusReportTimeout)
{
...
TEST_F_FROM_FIXTURE(TestReadInteraction, TestPostSubscribeRoundtripChunkReportTimeout)
{
...
TEST_F_FROM_FIXTURE(TestReadInteraction, TestPostSubscribeRoundtripChunkReport)
{
...
void TestReadInteraction::CheckForInvalidAction(chip::Test::MessageCapturer & messageLog)
{
...
#define PretendWeGotReplyFromServer(aClientExchange)                                                                               \
    {                                                                                                                              \
        Messaging::ReliableMessageMgr * localRm    = GetExchangeManager().GetReliableMessageMgr();                                 \
...
TEST_F_FROM_FIXTURE(TestReadInteraction, TestReadClientReceiveInvalidMessage)
{
...

    {
        ...
        PretendWeGotReplyFromServer(readClient.mExchange.Get());
...
TEST_F_FROM_FIXTURE(TestReadInteraction, TestSubscribeInvalidateFabric)
{
...
// TODO: Refactor after pigweed fix
